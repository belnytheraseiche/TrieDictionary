...
[TestClass]
public class HashMapRecordStoreTests
{
    HashMapRecordStore store_ = new();
    ...
    {
        var store1 = new TreapRecordStore();
        var values1 = new List<(int, int)>();
        for (var i = 0; i < 10000; i++)
        {
        ...
        var store2 = BasicRecordStore.Deserialize<TreapRecordStore>(serialized);
        var values2 = new List<(int, int)>();
